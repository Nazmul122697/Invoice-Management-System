  ...
  <div class="container">
    <div class="invoices">
      ...
      <div class="card__content">
        ...
        <div class="table">
          ...
          >
            ...
            <p v-else></p>
            <p style="color: red; font-size: 24px; cursor: pointer" @click="removeItem(i)">&times;</p>
          </div>
        ...
        <div class="table__footer">
          <div class="document-footer">
            ...
            <textarea cols="50" rows="7" class="textarea" v-model="form.description"></textarea>
          </div>
          <div>
      ...
      <div class="card__header" style="margin-top: 40px">
        <div></div>
        <div>
          <a class="btn btn-secondary" @click="onSubmitForm()"> Save </a>
        </div>
      </div>
    </div>
    <!--==================== add modal items ====================-->
