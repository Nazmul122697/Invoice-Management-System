...
// dd($invoice->id);
    ...
    public function deleteInvoiceItem($id){
        $invoiceItemData = InvoiceItem::findOrFail($id);
        $invoiceItemData->delete();
    }
}
